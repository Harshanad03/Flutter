...
class GetWorkerDetails extends StatefulWidget {
  const GetWorkerDetails({super.key});

  static const routeName = "/workersDetailsPage";
...
class _GetWorkerDetailsState extends State<GetWorkerDetails>
    with AutomaticKeepAliveClientMixin<GetWorkerDetails> {
  @override
